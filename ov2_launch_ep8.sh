...
rm -rf /ov2/feilong/gb200/_rt30b/hf_export
: > /ov2/feilong/gb200/_rt30b/ep8_export.log
docker exec -d -e CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 \
  ...
  bash -lc "cd $R && nohup python -m torch.distributed.run --standalone --nproc_per_node=8 ov2_30b_export_ep8.py > /ov2/feilong/gb200/_rt30b/ep8_export.log 2>&1 &"
echo "EP8 export launched"
