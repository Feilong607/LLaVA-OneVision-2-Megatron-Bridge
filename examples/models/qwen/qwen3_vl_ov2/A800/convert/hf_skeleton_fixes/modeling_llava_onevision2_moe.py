...
class LlavaOnevision2ForConditionalGeneration(LlavaOnevision2PreTrainedModel, GenerationMixin):
    ...
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        # After prefill, drop image inputs so the vision tower is not re-run on
        # decode steps. transformers 5.x no longer supplies cache_position to
        # remote-code models, so gate on is_first_iteration (Qwen3-VL convention).
